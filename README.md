...
Material and Methods (Meucci et al., submitted): Variant positions, reference and alternative alleles, and read depth counts per sample were extracted from the each genus-specific SNP dataset using R (R Core Team 2022). 
